                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{ route('master-province') }}">Province</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <section id="data-thumb-view" class="data-thumb-view-header">
                    ...
                    <div class="add-new-data-sidebar">
                        ...
                        <div class="add-new-data add-new-data-create">
                            <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
                                <div>
                                    <h4 class="text-uppercase">Add Province</h4>
                                </div>
                            ...
                            <div class="add-data-footer d-flex justify-content-around px-3 mt-2">
                                <div class="add-data-btn">
                                    <button class="btn btn-primary" id="add_data">Add Province</button>
                                </div>
                    ...
                    <div class="add-new-data-sidebar">
                        ...
                        <div class="add-new-data add-new-data-update">
                            <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
                                <div>
                                    <h4 id="update_title" class="text-uppercase">Update Province</h4>
                                </div>
                                <div class="hide-data-sidebar">
                                    <i class="feather icon-x"></i>
                                </div>
                            ...
                            <div class="add-data-footer d-flex justify-content-around px-3 mt-2">
                                <div class="add-data-btn">
                                    <button class="btn btn-primary" id="update_data">Update Province</button>
                                </div>
                                <div class="cancel-data-btn">
                                    <button class="btn btn-outline-primary">Cancel</button>
                                </div>
