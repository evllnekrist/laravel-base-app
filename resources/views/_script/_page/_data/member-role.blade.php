...
//Dropzone script
    ...
    $(document).ready(function() {
        ...
        var dataListView = $('.dataex-html5-selectors').DataTable( {
            ...
            responsive: false,
            ajax: {
                url: "{{ url('master/data/member-role/get') }}",
                type: 'GET',
        ...
        $('div').on("click","span.action-edit",function(e){
            ...
            $.ajax({
                url: 'member-role/'+hash+'/detailEdit',
                type:"GET",
