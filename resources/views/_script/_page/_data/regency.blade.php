...
//Dropzone script
    ...
    $(document).ready(function() {
        ...
        var dataListView = $('.dataex-html5-selectors').DataTable( {
            ...
            responsive: false,
            ajax: {
                url: "{{ url('master/data/regency/get') }}",
                type: 'GET',
            ...
            $.ajax({
                ...
                success:(function(data){
                   console.log(data);
                    ...
                    let prop ='', str = '<option value=""></option>';
                    for (let i = 0; i < (data.list_province).length; ++i) {
                        prop = (data.detail.province_id == data.list_province[i].id) ? 'selected="selected"' : '';
        ...
        $(document).on('change',"#add-province, #edit-province", function () {
            ...
            $.ajax({
                url: 'regency/'+province_id+'/detailRegency',
                type:"GET",
                success:(function(data){ 
                    let i = 1;                              
        ...
        function createForm(action){
            let str =   '<!-- '+action+' form : BEGIN -->\
                        <div class="col-sm-12 data-field-col">\
                            ...
                            <div class="form-group">\
                                <label for="'+action+'-name"><b>Regency Name</b></label>\
        ...
        function getFormData(action){
            let data = {
                ...
                province_id         : $('#'+action+'-province').val(),
            };
