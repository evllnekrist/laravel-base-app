...
//Dropzone script
    ...
    $(document).ready(function() {
        ...
        var dataListView = $(".data-thumb-view").DataTable({
            ...
            responsive: false,
            ajax: {
            url: "{{ url('master/data/company/get') }}",
            type: 'GET',
