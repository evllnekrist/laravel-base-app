...
class AB_DistrictController extends Controller
{
	public function __construct()
	{
		parent::__construct();
		$this->data['header_data']['js'] = array('._data.ab_district');
    }
    
    public function index(Request $request){
        return view('_page._data.index-ab_district',$this->data);
    }
    ...
    public function detailEdit($id){
        ...
        $single_regency = AB_Regency::where('id','=',$item['regency_id'])->first();
        $list_province = AB_Province::get();
